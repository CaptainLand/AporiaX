...
Two Builders can disagree on APIs, UI behavior, schemas, state semantics, or security even without editing the same file. 0.5.0 adds a collaboration protocol layer:
