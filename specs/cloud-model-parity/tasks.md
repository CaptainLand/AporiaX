...
- [x] Protocol and output-policy parity with regression tests (requirements 1, 2).
- [x] Safe upstream errors, reservation diagnostics and terminal metadata (requirements 5, 6).
