const TOOL_PRESENTATION = {
  ...
  read_external_file: ["lens", "读取外部文件", "Read external file", "等待批准后读取工作区外文件", "Waiting for approval to read an external file", "file-read"],
  ...
  start_process: ["trial", "启动常驻进程", "Start persistent process", "正在启动任务终端进程", "Starting a managed task process", "terminal"],
